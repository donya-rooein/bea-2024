...
@time_it
def main():
    # Load the Arman csv data into a DataFrame
    ...
    for index_problems, problem in df_texts.iterrows():
        ...
        # Text for emotion detection (replace this with your variable)
        ...
        try:
            ...
            with open('error_log_data_ll70.txt', 'a') as error_log_file:
                error_log_file.write(str(e) + '\n')

    df_texts.to_csv('rephrased_training.csv', index=False)
